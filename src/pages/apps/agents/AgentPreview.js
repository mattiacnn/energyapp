...
export default function AgentPreview({ customer, open, onClose }) {
  ...
  return (
    <>
      ...
      >
        <AddAgent customer={customer} onCancel={handleAdd} />
      </Dialog>

      <AlertAgentDelete title={customer.fatherName} open={openAlert} handleClose={handleClose} />
    </>
  );
}
