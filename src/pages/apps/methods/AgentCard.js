...
const AgentCard = ({ customer }) => {
  ...
  return (
    <>
      ...
      <AgentPreview customer={customer} open={open} onClose={handleClose} />
      <AlertAgentDelete title={customer.fatherName} open={openAlert} handleClose={handleAlertClose} />
    </>
  );
};
