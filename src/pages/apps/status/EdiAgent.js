  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        const response = await axios.put('/status/update', new_agent);
                  ...
                  <Stack spacing={1.25}>
                    <ListItem divider>
                      <ListItemText
                        ...
                        primary="Disabilita stato"
                        secondary="Disabilitando questo stato non verrà più visualizzato nel sistema"
                      />
                      <Switch
                        edge="end"
